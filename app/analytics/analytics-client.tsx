...
export default function AnalyticsClient() {
  ...
  useEffect(() => {
    if (selectedLeague && !loading && leaguesLoaded) {
      fetchOddsAnalysis();
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [minOdds, maxOdds]);
          ...
          <div className="mt-12 pt-8 border-t-2 border-gray-200">
            ...
            <div className="bg-slate-50 p-4 rounded-lg shadow-sm border border-slate-200 w-fit mb-6">
              ...
              {/* <p className="text-xs text-gray-500 mt-2">
                Analyzes first .5 line in this range
              </p> */}
            </div>
                  ...
                  <table className="min-w-full bg-white text-sm">
                    <thead className="bg-gray-100">
                      <tr>
                        ...
                        <th className="px-4 py-2 text-right border-b">Line</th>
                    ...
                    .map((game, idx) => (
                      ...
                      >
                        ...
                        <div className="flex justify-between items-center text-xs text-gray-900">
                          <span>
                            HT: {game.teamHalftime} - {game.oppHalftime} (Total:{" "}
                  ...
                  {matchupResult.awayTeam.gameLog
                    ...
                    .map((game, idx) => (
                      ...
                      >
                        ...
                        <div className="flex justify-between items-center text-xs text-gray-900">
                          <span>
                            HT: {game.oppHalftime} - {game.teamHalftime} (Total:{" "}
                            {game.halftimeTotal}) (oddsLine: {game.oddsLine})
                          </span>
                          {game.wentOver ? (
                            <span className="text-green-600 font-semibold">
