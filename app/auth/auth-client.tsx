          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-8 space-y-6">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold text-gray-900">
                {isSignIn
                  ? "Sign in to HoopEdge"
                  : "Create your HoopEdge account"}
              </h1>
              <p className="mt-1 text-sm text-gray-600">
                {isSignIn
                  ? "Access your basketball analytics dashboard"
                  : "Get started with half-time analytics"}
              </p>
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={isLoading}
                className="w-full cursor-pointer flex items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition disabled:opacity-50"
              >
